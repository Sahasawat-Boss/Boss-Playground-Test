            ...
            <div className='flex-grow '>
                <div className='container mx-auto shadow-xl my-10 p-10 rounded-xl'>
                    <div className='flex justify-between'>
                        ...
                        <div>
                            <Link href="/create" className='bg-green-600 text-white text-lg px-3 pb-[8px] py-2 rounded-lg hover:bg-green-500'>Create Content</Link>
                        </div>
                    </div>

                    {/* === User Posts Data === */}
                    <div>
                        <div className="shadow-xl my-6 p-10 rounded-xl">
                            <h3 className="text-xl my-2 underline">Content Title</h3>
                            ...
                            <div className='mt-5 '>
                                <Link className='bg-[#4848b9] hover:bg-blue-400 text-white border py-2 px-3 rounded-md text-lg my-2 mr-2' href="/edit">Edit This Content</Link>
                                <Link className='bg-[#b32b2b] hover:bg-red-400 text-white border py-2 px-3 rounded-md text-lg my-2' href="/delete">Delete This Content</Link>
                            </div>
                        </div>
                    </div>
                </div>
